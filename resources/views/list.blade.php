            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Painel de Usuários</h6>
                    </div>
                    <div class="card-body">
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form  method="POST" action= "{{route('list.update',['user' => $u->id])}}" enctype="multipart/form-data">
                                                        <input type="hidden" name="_token" value="{{{ csrf_token() }}}" />
                                                        <input type="hidden" name="_method" value="PUT">
                                                        <div class="row mx-5" id="gerenciarUsuarioID" >
                                                            <!--  <form> -->
...
{{--                                                                <i  aria-hidden="true"> </i>--}}
                                                        ...
                                                        <div class="row mx-5">
                                                            <div class="inputIcone form-group col-md-6">
                                                                <input id="matriculaImport" type="text2" placeholder="Matrícula" value="{{ $u->matricula }}" required="required" name="matricula" pattern="[0-9]+$"><br>
                                                        ...
                                                        <div class="row mx-5">
                                                            <div class="inputIcone form-group col-md-6">
                                                                <input id="emailImport" type="email2" placeholder="Email" name="email" value="{{ $u->email }}" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" /><br>
                                                                <i class="fa fa-mail-bulk fa-lg fa-fw" aria-hidden="true"> </i>
                                                            </div>
                                                            <div class="inputIcone form-group col-md-6">
                                                                <input name="telefone" id="telefone" maxlength="15" type="text2"  value="{{ $u->telefone }}" placeholder="Telefone" required="required"  ><br>
                                                        ...
                                                        <div class="row mx-5">
                                                            <div class="inputIcone form-group col-md-6">
                                                                <input name="password" id="password2" maxlength="6" type="password" placeholder="Digite sua senha" required="required"><br>
