...
<head>
    ...
    <title>Confirmação de Orientação</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">Confirmação de Orientação em Projeto De TCC II</h1>

                <a href=<?php $_SERVER['HTTP_HOST'] ?>"/btnTermo2" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Imprimir Termo</a>

                <embed src=<?php $_SERVER['HTTP_HOST'] ?>"/invoice2" width="760" height="500" >
