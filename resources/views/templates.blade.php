...
<!DOCTYPE html >
<html lang="pt-br" xmlns:margin-left="http://www.w3.org/1999/xhtml">
...
<head>
    ...
    <link href="tema/css/template.css" rel="stylesheet">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800" >Templates e Arquivos</h1>

            </div>
            <!-- /.container-fluid -->
            <!-- Formulário para Upload-->
            <img class="img-template"   src='imagens/generic.png'>
            ...
            @section('content')
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form class="" action="/templates" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; SGTCC 2019</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
