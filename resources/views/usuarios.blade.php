        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="row mx-5" id="gerenciarUsuarioID" style="">
                    {{ csrf_field() }}
                        ...
                        @endif
                            ...
                            <div class="inputIcone form-group col-md-6">
                                <input id="nomeImport" type="text2" placeholder="Nome" required="required" name="name">
                                <i class="fa fa-user fa-lg fa-fw" aria-hidden="true"> </i>
                            </div>

                            <div class="inputIcone form-group col-md-6">
                                <input id="sobrenomeImport" type="text2" placeholder="Sobrenome" name="sobrenome"><br>
                                <i class="fa fa-user-edit fa-lg fa-fw" aria-hidden="true"> </i>
                            </div>

                            <div class="inputIcone form-group col-md-4">
                                <select class=" formImport select2" id="atuacao" name="atuacao">
                                    <option value="Perfil" selected="true" disabled="disabled">Perfil</option>
                                    @if(!empty($atuacoes))
                            ...
                            <div class="inputIcone form-group col-md-4">
                                <select class="formImport select2" id="curso_id" name="curso_id">
                                    <option value="Curso" selected="true" disabled="disabled">Curso</option>
                                    @if(!empty($cursos))
                            ...
                            <div class="inputIcone form-group col-md-4">
                                <input id="matriculaImport" type="text2" placeholder="Matrícula" required="required" name="matricula" pattern="[0-9]+$"><br>
                                <i class="fa fa-portrait fa-lg fa-fw" aria-hidden="true"> </i>
                            </div>

                            <div class="inputIcone form-group col-md-8">
                                <input id="emailImport" type="email2" placeholder="Email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" /><br>
                                <i class="fa fa-mail-bulk fa-lg fa-fw" aria-hidden="true"> </i>
                            </div>

                            <div class="inputIcone form-group col-md-4">
                                <input name="telefone" id="telefone" maxlength="15" type="text2" placeholder="Telefone" required="required" ><br>
                                <i class="fa fa-phone fa-lg fa-fw" aria-hidden="true"> </i>
                            </div>

                            <div class="inputIcone form-group col-md-4">
                                Modalidade:<br>
                                <input id="tcc1Import" type="radio" name="Modalidade" value="TCC1"> TCC 1<br>
                                <input id="tcc2Import" type="radio" name="Modalidade" value="TCC2"> TCC 2<br><br>
                            </div>

                            <div id="importarID"  class="form-group col-md-12" style="display:none">
                                <p class="descImport">Importar por Matrícula</p>
                                <input id="matriculaImport" type="number2" name="Matricula"><br>
                            </div>

                            <div class="inputIcone form-group col-md-4">
                                <input name="password" id="password2" maxlength="6" type="password" placeholder="Senha" required="required"><br>
                                <i class="fa  fa-key fa-lg fa-fw" aria-hidden="true"> </i>
                            </div>
                    </div>

                        <div class="mx-auto">
                            <button id="cadastrarImport" type="submit"  value="Enviar" class="btn btn-primary">Cadastrar

                            </button>
                            <button id="importarImport" type="button" class="btn btn-danger" onclick="importarUsuario('importarID')">
                                Importar
                            </button>
                        </div>
                    </form>
