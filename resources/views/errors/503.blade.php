        ...
        <li class="nav-item">
            ...
            <div id="collapseArea" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{ route('usuarios') }}">Painel de usuários</a>
                </div>
            </div>
        </li>
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="text-center">
                    ...
                    <p class="lead text-gray-800 mb-5">Serviço Indisponível</p>
                    <p class="text-gray-500 mb-0">Tente novamente mais tarde ou entre em contato com a administração</p>
                    <a href="{{ route('index') }}">&larr; Voltar para o Dashboard</a>
                </div>
