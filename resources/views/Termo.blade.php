    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">Termo de Aceite de Orientação</h1>

                <a href=<?php $_SERVER['HTTP_HOST'] ?>"/btnTermo" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Imprimir Termo</a>

                <embed src=<?php $_SERVER['HTTP_HOST'] ?>"/invoice" width="760" height="500" >
