            ...
            <div class="container-fluid">
                ...
                <div class="row" id="contentPanel">
                    ...
                    @if(!empty($index))
                        @php
                            $cursos = $index["cursos"];
                            $quantProjeto = $index["countProjeto"];
                        @endphp
                        @if(!empty($cursos))
                                    ...
                                    <div class="card border-left-primary shadow h-100 py-2">
                                        <div class="card-body">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Quantidade de projetos: {{$quantProjeto[$curso->id]}} </div>
                                                    <div class="h5 mb-0 font-weight-bold text-gray-800"> {{ $curso->nome_curso }} </div>
                                                </div>
                                                <div class="col-auto">
                                                    <input type="text" style="display:none" name="idCurso">
                                                    <button id = "buttonCurso"  onclick="javascript: location.href= '{{ route('associar_aluno_projeto',$curso->id) }}'" value="{{ $curso->id }}" type="button" class="btn btn-primary btn-circle btn-sm" data-toggle="modal" data-target="#modalListProject">
...
<script src="tema/js/confirm.js"></script>
<script>
    function escolheCurso(idCurso) {
        // document.getElementById('buttonCurso').onClick = idCurso;
        $idCurso = idCurso;
        $('#idHolder').text( $idCurso );
        alert(idCurso);
    }
</script>
</body>
